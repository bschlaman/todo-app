...
CREATE TYPE task_status AS ENUM  ('BACKLOG', 'DOING', 'DONE', 'DEPRIORITIZED', 'ARCHIVE', 'DUPLICATE');

CREATE TYPE story_status AS ENUM ('BACKLOG', 'DOING', 'DONE', 'DEPRIORITIZED', 'ARCHIVE', 'DUPLICATE');
